...
function showAllBengkel(position) {
    ...
    let locationBengkel = [{
            ...
            content: '<div class="container d-flex justify-content-around modal-container">' +
                ...
                '<div>' +
                '<h1 class="modal-header">Intan Motor</h1>' +
                '<p class="modal-text">Jl. Siliwangi No.32G, Area Sawah, Nogotirto, Kec. Gamping, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55592</p>' +
